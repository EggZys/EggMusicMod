...
import logo from "@ui/assets/logo.svg?inline";

import { FaGithub } from "react-icons/fa";
import { RxUpdate } from "react-icons/rx";

const IS_DEV = false;
const GITHUB_REPO_URL = "https://github.com/EggZys/EggMusicMod/";
  ...
  const appMetaQuery = useQuery({
    ...
    queryFn: async () => {
      const data = await fetch(
        "https://raw.githubusercontent.com/EggZys/EggMusicMod/refs/heads/master/.meta/meta.json",
      );
      if (data.status !== 200) {
        ...
        <SheetContent side="left" className="w-full" onOpenAutoFocus={(e) => e.preventDefault()}>
          ...
          <div className="bg-secondary/20 m-3 mb-0 flex justify-between rounded-md border px-4 py-2 shadow-sm">
            <div className="flex items-center gap-2">
              ...
              />
              <span className="text-foreground text-base font-semibold">EggMusicMod</span>
