...
`EggMusicMod` - это автоматический патчер, который берет актуальную стабильную сборку Яндекс Музыки, вносит изменения и собирает модифицированное приложение.
...
## Как добавлять свои моды в EggMusicMod
